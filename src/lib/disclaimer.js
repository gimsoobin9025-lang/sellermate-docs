export const DISCLAIMERS = {
  ...
  en: 'Disclaimer: Results are strategic suggestions only and do not guarantee actual performance. Always verify metrics (search volume, sales, rankings) with official tools.',
}
