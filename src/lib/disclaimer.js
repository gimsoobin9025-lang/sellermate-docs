export const DISCLAIMERS = {
  ...
  en: 'Disclaimer: Results are strategic suggestions only and do not guarantee actual performance. Always verify all performance data with official analytics tools.',
}
